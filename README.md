local Rayfield = loadstring(game:HttpGet("https://raw.githubusercontent.com/Pedrin031/Ale-huub/refs/heads/main/README.md"))()
...
local Window = Rayfield:CreateWindow({
   ...
   Discord = {
      ...
      Invite = "https://discord.gg/wj5xpM8q", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ ABCD would be ABCD
      RememberJoins = true -- Set this to false to make them join the discord every time they load it up
   },

   KeySystem = false, -- Set this to true to use our key system
   KeySettings = {
      Title = "Pedrin Hub | Superior's Hub",
